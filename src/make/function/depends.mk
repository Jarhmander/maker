...
# Relink when those variables change
# NOTE: Only depend on file that actually exist, otherwise everything is rebuilt each time
...
# Any changes to the Makefile and the helpers may have a serious impact and all must be rebuilt
